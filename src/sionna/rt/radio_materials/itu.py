...
ITU_MATERIALS_PROPERTIES = {
    ...
    "vinyl_tile": {
        (1.0, 40.): (3.62, 0.0, 0.0051, 0.8422)
    },
    "carpet_tile": {
        (1.0, 40.): (2.08, 0.0, 0.0009, 0.82)
    },
    "asphalt_concrete": {
        (1.0, 40.): (4.83, 0.0, 0.0108, 1.3969)
    },
    "metal": {
        (1.0, 100.): (1.0, 0.0, 1e7, 0.0)
    },
    "very_dry_ground": {
        (1.0, 10.): (3.0, 0.0, 0.00015, 2.52)
    },
    "medium_dry_ground": {
        (1.0, 10.): (15., -0.1, 0.035, 1.63)
    },
    "wet_ground": {
        (1.0, 10.): (30., -0.4, 0.15, 1.30)
    }
}
...
def itu_material(
    ...
    for f_ranges, params in props.items():
        ...
        if name in strict_range_materials:
            raise ValueError(
                f"Properties of ITU material '{name}' are not"
                " defined for this frequency"
            )
